...
<section class="journal-hero-section">
 <div class="container">
  ...
  <div class="blog-list-filter">
    <ul>
      <li><a class="active" href="/journals">All</a></li>
      ...
      ?>
      <li><a href="<?php echo $category_link; ?>"><?php echo $journalscategorylistval->name; ?></a></li>
      <?php }} ?>
      <li><a href="/journals-categories/other/">Other</a></li>
    </ul>
  </div>
</div>
</section>
...
$journalPosts = array('post_type' => 'journals', 'meta_key' => 'featured','order' => 'DESC', 'showposts' => '9', 'paged' => $paged);
