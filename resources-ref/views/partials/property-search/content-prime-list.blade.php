<section class="imgcnt-info-sec mbt">
      <div class="container">
         <div class="imgcnt-info-grid ltr">
            <?php $lirc_image=get_field('lirc_image');
            if($lirc_image){
            ?>
            <div class="imgcl">
           ...
           <div class="cntcl">
             <div class="cntwrp-inner">
               <div class="heading-block">
                    <h2><?php echo get_field('lirc_title');?></h2>
               </div>
               <div class="cnttxt">
                   <?php echo get_field('lirc_excerpt');?>
               </div>
                <?php $lirc_button_link = get_field('lirc_button_link'); 
                if($lirc_button_link){?>
               <div class="btnwrp">
